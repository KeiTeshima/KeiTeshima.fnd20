...
element.value = "従業員番号を入力";

function join() {
    document.getElementsByClassName("thankyoubox")[0].innerText = "入会ありがとうございました";
}

const target = document.getElementsByClassName("join_button")[0];
target.addEventListener("click", join);
